/**
 * @namespace ST.Calender
 * @extends $.Widget.Control
 * @param _base
 */
ST.Calender = $.createClass($.Widget.Control,
  function (_base) {
    return /**@lends ST.Calender#*/{
        /**暂不支持此配置，格式为yyyy-MM-dd HH:mm:ss*/
...
/**
 * @namespace ST.CalenderCal
 * @type {{Month: string[], getWeek: getWeek, getDays: getDays, getMonthStr: getMonthStr, getIntYears: getIntYears}}
 */
ST.CalenderCal = {
    /**待补充*/
